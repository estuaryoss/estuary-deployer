...
if __name__ == "__main__":
    ...
    io_utils.create_dir(Path(EnvInit.init.get(EnvConstants.DEPLOY_PATH)))
    io_utils.create_dir(Path(EnvInit.init.get(EnvConstants.TEMPLATES_DIR)))
    io_utils.create_dir(Path(EnvInit.init.get(EnvConstants.VARS_DIR)))
